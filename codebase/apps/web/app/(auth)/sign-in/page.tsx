  ...
  return (
    <main className="auth-page">
      <div className="auth-card">
        ...
        <h1>Welcome back</h1>
        <p className="subtitle">Sign in to your AI-native presales workspace</p>
        <a href={googleUrl} className="auth-google-btn">
          <GoogleIcon />
          Continue with Google
        </a>
        <p className="auth-card__dev">
          Dev mode: use POST /api/v1/auth/dev-login, then paste token at{' '}
          <Link href="/auth/callback">/auth/callback</Link>
        </p>
        <LinkButton href="/" variant="ghost" size="sm" className="auth-card__back">
          ← Back to home
        </LinkButton>
      </div>
    </main>
